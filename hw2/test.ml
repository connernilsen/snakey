...
let expr_of_sexp_tests =
  [ t_any "expr_of_sexp0" (expr_of_sexp (parse "1")) (Number (1L, (0, 0, 0, 1)));
    ...
    t_any "expr_of_sexp_empty_add1" (expr_of_sexp (parse "(add1)")) (Id ("add1", (0, 1, 0, 5)));
    t_any "expr_of_sexp_empty_sub1" (expr_of_sexp (parse "(sub1)")) (Id ("sub1", (0, 1, 0, 5)));
...
let compile_env_tests =
  [t_any "compile_env_simple" (compile (Number (1L, (0, 9, 0, 10)))) [IMov (Reg RAX, Const 1L)];
   ...
   te "compile_env_add1_no_params" "(add1)" "Unbound variable `add1` referenced at line 0, col 1--line 0, col 5";
...
let integration_tests =
  [t "test.simple" "1" "1";
   ...
   tie "test_error3.adder" 
    "Unbound variable `add1` referenced at line 0, col 1--line 0, col 5";
